...
public class DeadMessageListener {
    ...
    @RabbitListener(queues = RabbitConstants.QUEUE_NAME_AGGR_DATA_DEAD_QUEUE)
    public void process(ServerResponse sendMessage, Channel channel, Message message) throws Exception {
        ...
        logger.info("[{}]处理死信队列消息队列接收数据，消息体：{}", RabbitConstants.QUEUE_NAME_AGGR_DATA_DEAD_QUEUE, msg);
